...
const Util = require(resolve(require.resolve("zelvbod.js").replace("index.js", "/util/Util.js")));
const Base = require(resolve(require.resolve("zelvbod.js").replace("index.js", "/structures/Base.js")));
const APIMessage = require(resolve(require.resolve("zelvbod.js").replace("index.js", "/structures/APIMessage.js")));
const { Error: DJSError } = require(resolve(require.resolve("zelvbod.js").replace("index.js", "/errors")));
...
const SHMPath = resolve(require.resolve("zelvbod.js").replace("index.js", "/client/websocket/WebSocketManager.js"));
...
const ItPath = resolve(require.resolve("zelvbod.js").replace("index.js", "/structures/Interaction.js"));
